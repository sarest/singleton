...
private:
    ...
    QString curve_angle,curve_radius,curve_acceleration,curve_velocity,curve_x,curve_y,curve_time;
    QString straight_length,straight_acceleration,straight_velocity,straight_x,straight_y,straight_time;
};
