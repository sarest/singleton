...
SOURCES       = main.cpp \
		...
		items/target.cpp \
		items/segment.cpp \
		views/myqgraphicsview.cpp moc_mainwindow.cpp \
...
DIST          = ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		items/target.h \
		items/segment.h \
		views/myqgraphicsview.h main.cpp \
		mainwindow.cpp \
		mediator.cpp \
		files.cpp \
		functions.cpp \
...
$(TARGET): ui_mainwindow.h ui_windowtarget.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h mediator.h files.h functions.h views/windowtarget.h items/target.h items/segment.h views/myqgraphicsview.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp mediator.cpp files.cpp functions.cpp views/windowtarget.cpp items/target.cpp items/segment.cpp views/myqgraphicsview.cpp $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.ui views/windowtarget.ui $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_mainwindow.cpp moc_windowtarget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_windowtarget.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_windowtarget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_windowtarget.h
